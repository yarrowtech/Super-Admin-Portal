# Backend Connected API Guide

All currently routed backend APIs are integration-ready based on implemented controller logic.

Generated at: 2026-04-23 15:48:46
Source: backend/swagger-output.json
Base URL: http://localhost:<PORT>
Auth Header: Authorization: Bearer <token>
Integration-ready operations: 260
Pending operations (placeholder): 0

## Auth Flow (Start Here)

1. POST /api/auth/login
2. Save access token
3. Send token in Authorization header for protected APIs
4. If token expires, call POST /api/auth/refresh-token
