...
router.post('/attendance/export', attendanceExportController.exportAttendanceCsv);
router.get('/attendance/export-history', attendanceExportController.getAttendanceExportHistory);
...
// Alias endpoints for profile intelligence APIs
...
// Performance System
router.get('/performance-system/overview', performanceSystemController.getOverview);
router.get('/performance-system/employees/:employeeId', performanceSystemController.getEmployeeSummary);
router.post('/performance-system/employees/:employeeId/recalculate', performanceSystemController.recalculateSnapshot);
router.get('/performance-system/snapshots', performanceSystemController.listSnapshots);
router.get('/performance-system/appraisal-cycles', performanceSystemController.listAppraisalCycles);
router.post('/performance-system/appraisal-cycles', performanceSystemController.createAppraisalCycle);
