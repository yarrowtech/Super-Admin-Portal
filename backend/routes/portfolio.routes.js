...
const { uploadMediaFile: uploadImage } = require('../modules/media/media.upload.middleware');
...
router.post('/:id/cover-image', requireAdmin, uploadImage(), ctrl.uploadCoverImage);
router.delete('/:id/cover-image', requireAdmin, ctrl.removeCoverImage);
...
router.post('/:id/sections/:sectionId/items/:itemId/image', requireAdmin, uploadImage(), ctrl.uploadItemImage);
router.delete('/:id/sections/:sectionId/items/:itemId/image', requireAdmin, ctrl.removeItemImage);
