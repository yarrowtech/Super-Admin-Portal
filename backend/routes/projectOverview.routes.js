...
const ROLE_PORTAL = {
  ...
  [ROLES.IT]: 'it',
  [ROLES.IT_ADMIN]: 'it',
  [ROLES.SYSTEM_OPERATOR]: 'it',
  [ROLES.SECURITY_ANALYST]: 'it',
  [ROLES.DEVOPS_ENGINEER]: 'it',
  [ROLES.HR]: 'hr',
...
const PORTAL_ROLES = {
  law: new Set([ROLES.LAW, ROLES.LEGAL_HEAD, ROLES.LSW, ROLES.CEO]),
  it: new Set([ROLES.IT, ROLES.IT_ADMIN, ROLES.SYSTEM_OPERATOR, ROLES.SECURITY_ANALYST, ROLES.DEVOPS_ENGINEER, ROLES.CEO]),
  hr: new Set([ROLES.HR, ROLES.CEO]),
  finance: new Set([ROLES.FINANCE, ROLES.FINANCE_MANAGER, ROLES.ACCOUNTANT, ROLES.AUDITOR, ROLES.CEO]),
  manager: new Set([ROLES.MANAGER, ROLES.CEO]),
  employee: new Set([ROLES.EMPLOYEE]),
  research: new Set([ROLES.RESEARCH_OPERATOR, ROLES.CEO]),
  ceo: new Set([ROLES.CEO]),
  sales: new Set([ROLES.SALES, ROLES.CEO]),
};
