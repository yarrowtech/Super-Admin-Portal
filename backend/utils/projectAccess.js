const PROJECT_REGISTRY = [
  ...
  },
  {
    code: 'BETTERPASS',
    name: 'BetterPass',
    description: 'Identity and access workspace.',
    launchUrl: process.env.BETTERPASS_PORTAL_URL || 'https://betterpass.company.com',
    ssoPath: '/sso-login',
    aliases: ['BetterPass'],
  },
  {
    ...
    launchUrl: process.env.EFMBMS_PORTAL_URL || 'https://efmbms.company.com',
    ssoPath: '/sso-login',
    aliases: ['EFMBMS', 'EFMB MS'],
  },
];
