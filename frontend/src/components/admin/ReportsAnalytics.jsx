...
const ReportsAnalytics = () => {
  ...
  const filteredReports = useMemo(() => {
    if (statusFilter === 'All') return customReports;
    return customReports.filter((r) => r.status === statusFilter);
  }, [statusFilter]);
  ...
  return (
    <main className="flex-1 overflow-y-auto p-4 md:p-5">
      <div className="mx-auto w-full max-w-[1500px]">
        ...
        <section className="mb-4 rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-900 lg:p-5">
        ...
        <section className="mb-4">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {predefinedReports.map((report) => (
              <div key={report.title} className="flex min-h-[180px] flex-col gap-3 rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-900 lg:p-5">
          ...
          <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-900 lg:p-5">
              <div className="mb-4 flex items-center justify-between gap-2">
                <h3 className="text-lg font-bold text-neutral-900 dark:text-neutral-100">Recent Custom Reports</h3>
                <select value={statusFilter} onChange={(e) => setStatusFilter(e.target.value)} className="rounded-lg border border-neutral-300 px-2 py-1 text-sm dark:border-neutral-700 dark:bg-neutral-800">
                  <option>All</option>
