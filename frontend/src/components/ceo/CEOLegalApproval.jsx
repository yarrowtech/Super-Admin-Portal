...
const DocPreviewPanel = ({ doc, versions, onApprove, onRejectClick, onDownloadPdf, actionLoading, onClose }) => {
  if (!doc) return null;
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex items-center gap-3 border-b border-neutral-200 dark:border-neutral-700 px-5 py-3 bg-neutral-50 dark:bg-neutral-800/50">
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-xl border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-sm font-semibold text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800"
        >
...
const CEOLegalApproval = () => {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      const { blob, filename } = await getLegalDocumentPdf(token, selectedDoc._id);
