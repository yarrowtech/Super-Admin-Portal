...
const CEOPortal = () => {
  ...
  return (
    <NotificationProvider>
      <div className="portal-shell relative flex min-h-screen w-full font-display bg-background-light text-neutral-800 dark:bg-background-dark dark:text-neutral-100" data-role="ceo">
