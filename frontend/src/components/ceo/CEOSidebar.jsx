        ...
        {!collapsed && (
          <div className="flex min-w-0 flex-1 items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="truncate text-sm font-bold text-neutral-900 dark:text-neutral-100">CEO Console</p>
              <p className="truncate text-[11px] text-neutral-400 dark:text-neutral-500">Executive Access</p>
            </div>
          </div>
        )}
        <button
