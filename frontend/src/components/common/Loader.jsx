...
// Self-contained (no styled-components dependency, matching this codebase's
// Tailwind-only convention) — the keyframe animation can't be expressed as
// Tailwind utilities, so it ships as a scoped <style> tag. Safe to inline
// since this is only ever mounted as a single full-page loading state.
const Loader = ({ size = '2.8rem', color = '#135bec', className = '' }) => (
  <div className={`dot-spinner ${className}`} style={{ '--uib-size': size, '--uib-color': color }}>
