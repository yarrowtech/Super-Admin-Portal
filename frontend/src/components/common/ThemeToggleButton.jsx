...
// Self-contained (no styled-components dependency, matching Loader.jsx's
// convention) — ships its own scoped <style> tag since the animations can't
// be expressed as Tailwind utilities alone.
const ThemeToggleButton = () => {
  ...
  return (
    <label className="theme-switch" title={isDark ? 'Switch to light mode' : 'Switch to dark mode'}>
      ...
      <input type="checkbox" className="theme-switch__input" checked={isDark} onChange={toggleTheme} aria-label="Toggle dark mode" />
