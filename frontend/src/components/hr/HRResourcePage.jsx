...
const HRResourcePage = () => {
  ...
  if (!resource) {
    return (
      <HrPageShell title="HR Resource" subtitle="Requested HR resource was not found." icon="inventory_2">
  ...
  return (
    <HrPageShell title={title} subtitle={description} icon={resource.icon || 'inventory_2'}>
