...
const sections = [
  {
    ...
    items: [
      { label: 'Add New Employee', path: '/hr/modules/employees-records' },
      { label: 'Edit Employee Profile', path: '/hr/modules/employees-records' },
      { label: 'Deactivate/Exit Employee', path: '/hr/modules/employees-records' },
      { label: 'Employee Documents', path: '/hr/modules/employees-documents' },
