...
const DEFAULT_PRODUCTS = [
  ...
  { key: 'ERMS', label: 'ERMS', fullName: 'ERMS', category: 'Core Product', description: 'Records and management workspace', icon: 'receipt_long' },
  { key: 'BETTERPASS', label: 'BetterPass', fullName: 'BetterPass', category: 'Identity Product', description: 'Access and identity workspace', icon: 'verified_user' },
