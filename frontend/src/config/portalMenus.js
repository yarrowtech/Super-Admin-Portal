export const portalMenuConfig = {
  ...
  manager: [
    ...
    { label: 'Recruitment',  icon: 'person_search', path: '/manager/recruitment', description: 'Post jobs and review candidates' },
    { label: 'Outsourcing',  icon: 'handshake',    path: '/manager/outsourcing',  description: 'Assign & track freelancer work' },
